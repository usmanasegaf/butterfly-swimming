...
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($murid->swimmingCourse)
                                                <span class="badge badge-info">
                                                    {{ $murid->pertemuan_ke }} / {{ $murid->jumlah_pertemuan_paket }}
                                                </span>
                                            @else
                                                N/A
                                            @endif
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Aksi Murid">
                                                ...
                                                <form action="{{ route('guru.murid.destroy', $murid->id) }}" method="POST"
                                                    onsubmit="return confirm('Apakah Anda yakin ingin melepaskan bimbingan murid ini?')">
                                                    @csrf
                                                    @method('DELETE')
                            ...
                            <select name="swimming_course_id" id="swimming_course_id_assign" class="form-control" required>
                                ...
                                @foreach ($availableCourses as $course)
                                    <option value="{{ $course->id }}">
                                        ...
                                        Rp{{ number_format($course->price, 0, ',', '.') }} (Durasi:
    ...
    <div class="modal fade" id="extendCourseModal" tabindex="-1" role="dialog" aria-labelledby="extendCourseModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="extendCourseForm" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="additional_weeks" id="additional_weeks" class="form-control"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.extend-course-btn').on('click', function() {
                ...
                $('#currentEndDateExtendModal').text(currentEndDate ? new Date(currentEndDate)
