    ...
    <div class="container">
        <div class="row text-center mb-5">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="lead text-muted">Kami menawarkan pengalaman belajar renang terbaik dengan berbagai keunggulan</p>
            </div>
        </div>
        <div class="row g-4">
            <div class="col-md-4">
                <div class="text-center p-4">
                    ...
                    <p class="text-muted">Semua pelatih kami adalah profesional bersertifikat dengan pengalaman bertahun-tahun.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="text-center p-4">
                    ...
                    <h4>Kelas Kecil</h4>
                    <p class="text-muted">Kami membatasi jumlah peserta per kelas untuk memastikan setiap peserta mendapat perhatian yang cukup.</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="text-center p-4">
                    ...
                    <p class="text-muted">Kolam renang dengan standar internasional dan fasilitas pendukung yang lengkap.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card program-card shadow h-100">
                    <img src="{{ asset('images/' . $program['image']) }}" class="card-img-top" alt="{{ $program['name'] }}">
                    <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card testimonial-card shadow h-100">
                    <div class="card-body text-center p-4">
                        <img src="{{ asset('images/' . $testimonial['image']) }}" class="testimonial-img" alt="{{ $testimonial['name'] }}">
