...
// Area Chart - Pendaftaran Murid Baru Per Bulan
var ctxArea = document.getElementById("myAreaChart");
var myLineChart = new Chart(ctxArea, {
    type: 'line',
    data: {
        labels: @json($muridPerBulanLabels), // Menggunakan data dinamis dari controller
        datasets: [{
            ...
            pointHitRadius: 10,
            pointBorderWidth: 2,
            data: @json($muridPerBulanData), // Menggunakan data dinamis dari controller
        }],
    },
    options: {
