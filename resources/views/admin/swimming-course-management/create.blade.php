        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Tambah Kursus Renang Baru</h5>
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('swimming-course-management.store') }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('sessions_per_week') is-invalid @enderror" id="sessions_per_week" name="sessions_per_week" value="{{ old('sessions_per_week') }}" required>
