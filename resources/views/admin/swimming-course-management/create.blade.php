                        ...
                        <form method="POST" action="{{ route('swimming-course-management.store') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('jumlah_pertemuan') is-invalid @enderror"
                                    ...
                                    <option value="4" {{ old('jumlah_pertemuan') == 4 ? 'selected' : '' }}>4x
                                        Pertemuan</option>
                                    <option value="8" {{ old('jumlah_pertemuan') == 8 ? 'selected' : '' }}>8x
                                        Pertemuan</option>
                                    <option value="12" {{ old('jumlah_pertemuan') == 12 ? 'selected' : '' }}>12x
                                        Pertemuan</option>
                                </select>
