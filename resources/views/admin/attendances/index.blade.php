...
<div class="container-fluid">
    <h1 class="h3 mb-4 text-gray-800">Manajemen Absensi Global</h1>
        ...
        <div class="card-body">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select name="student_id" id="student_id" class="form-control">
                            ...
                            @foreach ($murids as $murid)
                                <option value="{{ $murid->id }}" {{ request('student_id') == $murid->id ? 'selected' : '' }}>{{ $murid->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3 mb-3">
            ...
            <form action="{{ route('admin.attendances.report.generate') }}" method="GET">
                ...
                @foreach(request()->query() as $key => $value)
                    ...
                    @if(!in_array($key, ['report_type', 'weekly_date', 'monthly_month', 'monthly_year', 'yearly_year', 'start_date_custom', 'end_date_custom']))
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="report_type" id="reportTypeCustom" value="custom_range">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" id="monthly_year" name="monthly_year">
                                @for ($i = date('Y'); $i >= date('Y') - 5; $i--) {{-- Display last 5 years --}}
                ...
                <div id="customRangePeriod" class="form-group" style="display: none;">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" id="custom_start_date" name="start_date_custom" value="{{ request('start_date_custom') ?? date('Y-m-d') }}">
                        </div>
                        <div class="col-md-6">
                            <label for="custom_end_date">Tanggal Selesai Kustom:</label>
                            <input type="date" class="form-control" id="custom_end_date" name="end_date_custom" value="{{ request('end_date_custom') ?? date('Y-m-d') }}">
                        </div>
                    </div>
                </div>
